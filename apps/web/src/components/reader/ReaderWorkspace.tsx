        ...
        >
            <div className="reader-chat-pane h-full overflow-hidden rounded-[var(--radius-panel)]">
                {isOnline ? (
                    ...
                    <div className="flex h-full items-center justify-center p-8 text-center text-sm leading-relaxed text-[var(--color-chat-muted)]">
                        Chat needs an internet connection. Your book and reading
                        progress are available offline.
                    </div>
                )}
            </div>
            <div
                ...
                {isMobile ? (
                    ...
                    >
                        ...
                        {isOnline ? (
                            ...
                            <div className="absolute inset-x-4 bottom-4 z-[var(--z-dropdown)] rounded-[var(--radius-panel)] bg-[var(--color-chat)] p-4 text-center text-sm leading-relaxed text-[var(--color-chat-muted)]">
                                Chat needs an internet connection. Your book and
                                reading progress are available offline.
                            </div>
                        )}
                    </div>
                ) : (
